...
import { ArrowRight, CalendarClock, MessageSquareText, Radio, Users, ShieldCheck, Sparkles } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="relative mx-auto max-w-7xl px-4 pb-24 pt-20 sm:px-6 lg:px-8 lg:pt-28">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="mt-9 flex flex-wrap items-center justify-center gap-3">
              <Link
                href="/events"
                className="group inline-flex h-11 items-center gap-2 rounded-md bg-primary px-5 text-sm font-semibold text-primary-foreground shadow-[0_12px_40px_-12px_color-mix(in_oklab,var(--primary)_70%,transparent)] transition-all hover:brightness-110"
              >
                Explore events
              ...
              <a
                href="#features"
                className="inline-flex h-11 items-center rounded-md border border-border bg-card/50 px-5 text-sm font-semibold backdrop-blur transition-colors hover:bg-card"
              >
                See features
              </a>
            </div>
      ...
      {!loading && !error && past.length > 0 && (
        <section className="mx-auto max-w-7xl px-4 pb-20 sm:px-6 lg:px-8">
          <div className="flex items-end justify-between gap-6">
            <div>
              <p className="text-sm font-medium text-muted-foreground">Previously</p>
              <h2 className="mt-2 text-3xl font-semibold tracking-tight sm:text-4xl">Past events</h2>
            </div>
          </div>
          <div className="mt-10 grid gap-6 md:grid-cols-2 lg:grid-cols-3 opacity-60">
        ...
        <div className="relative overflow-hidden rounded-3xl border border-border/70 bg-gradient-to-br from-primary/15 via-card to-card p-10 sm:p-16">
          ...
          <div className="relative mx-auto max-w-2xl text-center">
            ...
            <div className="mt-8">
              <Link
                href="/events"
                className="inline-flex h-11 items-center gap-2 rounded-md bg-primary px-6 text-sm font-semibold text-primary-foreground shadow-lg transition-all hover:brightness-110"
              >
